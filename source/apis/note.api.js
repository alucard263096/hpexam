...
export class NoteApi {
  ...
  list(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'note/list',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  //更新或者新增相册
  one(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'note/one',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  update(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'note/update',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
  ...
  adelete(json, callback, showLoading = true) {
    ...
    console.log(header);
    wx.request({
      url: ApiConfig.GetApiUrl() + 'note/delete',
      data: json,
      method: 'POST',
      dataType: 'json',
      header: header,
